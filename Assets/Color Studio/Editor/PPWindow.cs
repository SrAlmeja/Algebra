...
namespace ColorStudio {
    ...
    public partial class PPWindow : EditorWindow {
        ...
        void DrawCanvasArea() {
            ...
            EditorGUILayout.BeginHorizontal();
            if (GUILayout.Button("Forum", GUILayout.Height(32))) Application.OpenURL("https://kronnect.me/taptapgo/index.php/board,76.0.html");
            if (GUILayout.Button("Kronnect Assets", GUILayout.Height(32))) Application.OpenURL("https://assetstore.unity.com/lists/kronnect-assets-29558?aid=1101lGsd");
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.EndVertical();
